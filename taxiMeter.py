...
class WinForm(QWidget):
    ...
    def showContents(self):
        ...
        if self.time_display % 600 == 0:
            self.c1 = self.c1 + 1
        self.money = round(min1 + self.min2 + self.min3 + 10*self.c0 + 100*self.c1, 2) # 操！
    ...
    def printInfo(self):
        try:
            ...
            pyperclip.copy(f'/do 感谢你搭乘洛圣都出租车,计价器显示信息:起步费7$ 行程收费{money} 总共消耗时间:{time} 总计费:{money_total} 请向出租车司机支付车费,检查随身携带物品,祝你有美好的一天。')
